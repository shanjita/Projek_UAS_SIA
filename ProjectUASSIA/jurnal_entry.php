	...
	<div class="container-fluid" style="margin:8 0 20 0;height: 800px;">
		<div class="row">	
			...
			<div class="col-sm-8" style="background:white;margin:0 0 10 10;height:800px;overflow:hidden;">
				...
				<h2 style="text-shadow: 2px 2px lightgrey;text-align:center;"><b>Data Supplier</b></h2>
			...
			<!-- disini masukkan contentnya -->
				<a class="btn btn-info" href="jurnal_input.php?aksi=input">Record Jurnal Entry</a></li>
                                        ...
                                        <table class="table users-table table-condensed table-hover" >
                                            ...
                                            <tbody>
                                                <?php
                                                $query = mysqli_query($con, "SELECT * FROM jurnal ");
                                                while ($row = mysqli_fetch_array($query)) {
                                                    ?>
                                                        <tr>
                                                            <td class="visible-lg"><?php  echo  $row['tgl_jurnal']; ?></td>
                                                            <td class="visible-lg"><?php echo"<br>"; echo $row['akun1']; echo "<br>"; echo$row['akun2']; ?></td>
                                                            <td class="visible-lg"><?php echo "<br>Rp "; echo $row['harga_debit']; echo "<br>-"."<br>"; ?></td>
                                                            <td class="visible-lg"><?php echo "<br>-"."<br>Rp ";  echo $row['harga_kredit']; ?></td>
                                                            <td>
                                                            </td>
                                                        </tr>
