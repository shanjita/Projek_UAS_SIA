...
<div class="col-md-12">
    ...
    <div class="panel panel-warning">
      ...
      <div class="panel-body">
                <form action="pembelian_input_sql.php?aksi=insert" method="GET" class="form-horizontal row-border">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
               ...
               <div class="col-sm-6">
                   <input type="text" name="banyaknya" class="form-control" id="phext"/>
               </div></div>
               <div class="form-group">
...
<div class="panel-footer">
  <div class="row">
   <div class="col-sm-6 col-sm-offset-3">
    ...
    <a href="pembelian.php" button type="button" class="btn btn-danger">Cancel</button></a>
  </div>
</div>
</div> <!-- panel footer -->
 </form>
...
<?php }else{?>
 <?php
 $id=$_GET['id'];
 $query = mysqli_query($con, "SELECT * FROM pembelian WHERE no_transaksi=$id");
    ...
    <div class="panel panel-warning">
      ...
      <i class="glyphicon glyphicon-cog"></i>
        <b>Edit Pembelian</b>
                ...
                <form action="pembelian_input_sql.php?aksi=update&id=<?php echo $row['no_transaksi']; ?>" method="GET" class="form-horizontal row-border">
