		...
		<div class="row">	
			<div class="col-sm-2" style="background-color:white;height:800px;">
				...
				<h4 id="judul"><b>Data</b></h4>
					...
					<li><a class="active" href="supplier.php">Pemasok</a></li>
...
<?php if($_GET['aksi']=="input"){ ?>
                <form action="supplier_input_sql.php?aksi=insert" method="GET" class="form-horizontal row-border">
                     <input type="hidden" name="aksi" value="insert"> 
          <div class="panel-body">
              <div class="form-group">
                <label class="col-sm-3 control-label">Nama</label>
                <div class="col-sm-6">
                    <input type="text" name="nama" class="form-control" id="phone"/>
                </div>
              ...
              <div class="form-group">
               ...
               <div class="col-sm-6">
                   <input type="text" name="alamat" class="form-control" id="phext"/>
               </div>
              ...
              <div class="form-group">
               ...
               <div class="col-sm-6">
                   <input type="email" name="email" class="form-control" id="phext"/>
               </div>
               ...
               <div class="col-sm-6">
                   <input type="text" name="no_hp" class="form-control" id="phext"/>
               </div>
...
<div class="panel-footer">
  <div class="row">
   <div class="col-sm-6 col-sm-offset-3">
    ...
    <a href="supplier.php" button type="button" class="btn btn-danger">Cancel</button></a>
  </div>
</div>
</div> <!-- panel footer -->
 </form>
...
<?php }else{?>
 ...
 $id=$_GET['id'];
                ...
                <form action="supplier_input_sql.php?aksi=update&id=<?php echo $row['id_supplier']; ?>" method="GET" class="form-horizontal row-border">
                    <input type="hidden" name="aksi" value="update">
                    <input type="hidden" name="id" value="<?php echo $row['id_supplier']; ?>">
                    <div class="panel-body">
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label">Nama</label>
                <div class="col-sm-6">
                    <input type="text" value="<?php echo $row['nama']; ?>" name="nama" class="form-control" id="phone"/>
                </div>
              ...
              <div class="form-group">
               <label class="col-sm-3 control-label">Alamat</label>
               <div class="col-sm-6">
                   <input type="text" value="<?php echo $row['alamat']; ?>" name="alamat" class="form-control" id="phext"/>
               </div>
              ...
              <div class="form-group">
               <label class="col-sm-3 control-label">Email</label>
               <div class="col-sm-6">
                   <input type="text" value="<?php echo $row['email']; ?>" name="email" class="form-control" id="phext"/>
               </div>
              ...
              <div class="form-group">
               ...
               <div class="col-sm-6">
                   <input type="text" value="<?php echo $row['no_hp']; ?>" name="no_hp" class="form-control" id="phext"/>
               </div>
