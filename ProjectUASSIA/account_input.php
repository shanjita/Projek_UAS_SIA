...
<!-- input masks -->
 <form action="account_input_sql.php?aksi=insert" method="GET" class="form-horizontal row-border">
               ...
               <label class="col-sm-3 control-label">Tipe Akun</label>
                <div class="col-sm-6">
                   ...
                   echo "<option value=1>Asset</option>";
                    ...
                    echo "<option value=3>Equity</option>";
           ...
           <div class="col-md-12">
            <div class="panel panel-cascade">
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label">No Akun</label>
                <div class="col-sm-6">
                    <input type="text" value="<?php echo $row['no_account']; ?>" name="no" class="form-control" id="phone"/>
                </div>
                <div class="col-sm-3">
