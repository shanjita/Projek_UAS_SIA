	...
	<div class="container-fluid" style="margin:8 0 20 0;height: 800px;">
		<div class="row">	
			...
			<div class="col-sm-8" style="background:white;margin:0 0 10 10;height:800px;overflow:hidden;">
				...
				<h2 style="text-shadow: 2px 2px lightgrey;text-align:center;"><b>Dashboard</b></h2>
								<br>
								<div class="colored">
                                    <div class="red"></div>
                                        <div class="blue"></div>
					...
					<div class="col-lg-3" style="text-align:center; margin:35px;">
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="panel panel-warning">
									...
									<link> <a href="account.php" target="_blank"><span class="glyphicon glyphicon-open"> </span> OPEN</a></link>
								</div>
							</div>
						</div>	
					</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="panel panel-warning">
									...
									<link> <a href="supplier.php" target="_blank"><span class="glyphicon glyphicon-open"> </span> OPEN</a></link>
								</div>
							</div>
						</div>	
					</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="panel panel-warning">
									...
									<link> <a href="item.php" target="_blank"><span class="glyphicon glyphicon-open"> </span> OPEN</a></link>
								</div>
							</div>
						</div>	
					</div>
					
					<div class="col-lg-5 " style="text-align:center; margin:35px;">
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="panel panel-warning">
									<div class="panel-heading"> 
									...
									<link> <a href="pembelian.php" target="_blank"><span class="glyphicon glyphicon-open"> </span> OPEN</a></link>
								</div>
							</div>
						</div>	
					</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="panel panel-warning">
									...
									<link> <a href="penjualan.php" target="_blank"><span class="glyphicon glyphicon-open"> </span> OPEN</a></link>
								</div>
							</div>
						</div>	
					</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="panel panel-warning">
									...
									<link> <a href="pengeluaran.php" target="_blank"><span class="glyphicon glyphicon-open"> </span> OPEN</a></link>
								</div>
							</div>
						</div>	
					</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="panel panel-warning">
									...
									<link> <a href="labarugi.php" target="_blank"><span class="glyphicon glyphicon-open"> </span> OPEN</a></link>
								</div>
							</div>
						</div>	
					</div>				
