	...
	<div class="container-fluid" style="margin:8 0 20 0;height: 800px;">
		<div class="row">
			...
			<div class="col-sm-8" style="background:white;margin:0 0 10 10;height:800px;overflow:hidden;">
				...
				<h2 style="text-shadow: 2px 2px lightgrey;text-align:center;"><b>Penjualan</b></h2>
				...
				<!-- Gallery Items -->
        <a href="penjualan_input.php?aksi=input" class="btn btn-shadow btn-info" >Tambah Penjualan</i>
                                                ...
                                                while ($row = mysqli_fetch_array($query)) {
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="visible-lg"><?php echo "Rp ".$row['harga_jual']. ",00"; ?></td>
                                                            <td class="visible-lg"><?php echo $row['keterangan']; ?></td>
                                                            <td class="visible-lg"><?php echo $row['nama_barang']; ?></td>
                                                            <td>
                                                              <a href="penjualan_input.php?aksi=edit&id=<?php echo $row['no_transaksi']; ?>" class="btn btn-info">Edit<i class="fa fa-edit"></i></a>
                                                              <a href="penjualan_input_sql.php?aksi=delete&id=<?php echo $row['no_transaksi']; ?>&nama=<?php echo $row['nama_barang'];?>" class="btn btn-warning">Hapus<i class="fa fa-eraser"></i></a>
                                                            </td>
                                               					</tr>
                                                        <?php
                                                    }
